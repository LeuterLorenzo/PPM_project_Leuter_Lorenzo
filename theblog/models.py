...
class Profile(models.Model):
    ...
    profile_pic = models.ImageField(null=True, blank=True, upload_to='images/profile/', default='images/default/default_profile.png')
...
class Post(models.Model):
    ...
    unlikes = models.ManyToManyField(User, related_name='blog_posts_u')
